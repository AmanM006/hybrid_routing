...
```bash
ghcr.io/amanm006/hybrid_routing-v1:v25
```
...
**Valid tags:** `v25` (canonical), `latest` (always points to newest release)
...
docker pull ghcr.io/amanm006/hybrid_routing-v1:v25
```
